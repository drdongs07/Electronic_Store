...
public class ProductController {
    ...
    public ResponseEntity<ImageResponse> uploadProductImage(
        ...
        ProductDto updatedProduct = productService.update(productDto, productId);
        ImageResponse response = ImageResponse.builder().imageName(updatedProduct.getProductImageName()).message("Product image is uploaded successfully!!").status(HttpStatus.CREATED).success(true).build();
